...
For a complete list of APIs and examples, see the [godoc documentation](https://pkg.go.dev/github.com/Taoidle/minio-go/v7) or [Go Client API Reference](https://min.io/docs/minio/linux/developers/go/API.html).
...
```sh
go get github.com/Taoidle/minio-go/v7
```
...
import (
	...
	"github.com/Taoidle/minio-go/v7"
	"github.com/Taoidle/minio-go/v7/pkg/credentials"
)
...
go get github.com/Taoidle/minio-go/v7
go get github.com/Taoidle/minio-go/v7/pkg/credentials
...
* [Godoc Documentation](https://pkg.go.dev/github.com/Taoidle/minio-go/v7)
